...
var opts = {
    ...
    repaintColor: '#1a1a1a', // Color for canvas repaint
    connectionColor: '#fff', // Color for connections
    rootColor: '#fff', // Color for the root connection
    endColor: '#fff', // Color for end connections
    dataColor: '#fff', // Color for data points
